                    ...
                    <div class="card-content">
                        ...
                        <div class="contact-form"  style="padding: 30px;">
                            <form action="" method="post" name="signup">
                                <input required name="prenom" type="text" placeholder="Prenom"><br/>
                                <input required name="nom" type="text" placeholder="Nom"><br/>
                                <input required name="email" type="email" placeholder="Adresse e-mail"><br/>
                                <input required name="password" type="password" placeholder="Mot de passe"><br/>
                                <input required name="confirm_password" type="password" placeholder="Confirmez le mot de passe"><br/>
