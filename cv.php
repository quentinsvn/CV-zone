                        ...
                        <div class="job-card-details-item">
                            <div class="flex-start">
                                ...
                                <div class="job-title">
                                    ...
                                    <span>Recherche un(e) <?php echo $contrat; ?></span>
                                </div>
                            </div>
                            <div class="job-apply-section">
                                <p>Le <?php echo $mysqldate; ?></p>
                                <a class="btn-login" style="color: white; text-decoration: none;" href="mailto:<?php echo $email; ?>">Contacter</a>
                            </div>
                        </div>
                        <div class="contrat-details">
                            <ul>
                                <li><span><i class="fas fa-birthday-cake"></i> <?php echo $age ?> ans</span></li>
                                <li><span>|</span></li>
                                <li><span><i class="fas fa-school"></i> <?php echo $ecole ?></span></li>
                                <li><span>|</span></li>
                                <li><span><i class="fas fa-map-marker-alt"></i> <?php echo $ville ?></span></li>
                            </ul>
                        </div>
